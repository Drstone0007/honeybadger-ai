...
function initMermaid() {
  if (!window.mermaid || window.__honeybadgerMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__honeybadgerMermaidReady = true;
}
window.honeybadgerInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'honeybadger-thinking-expanded';
