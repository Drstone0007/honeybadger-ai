...
const LS_KEY = 'honeybadger-theme';
const CUSTOM_THEMES_KEY = 'honeybadger-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Honey Badger Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'honeybadger_' + (obj.name || 'theme') + '.json';
      a.click();
