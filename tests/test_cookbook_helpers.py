...
def test_serve_runner_preserves_command_exit_code():
    ...
    assert "HONEYBADGER_CMD_EXIT=$?" in script
    assert 'echo "=== Process exited with code $HONEYBADGER_CMD_EXIT ==="' in script
