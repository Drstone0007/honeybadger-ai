...
Honey Badger began as a Linux/macOS/Docker-only app. This module centralizes the
...
def find_bash() -> Optional[str]:
    ...
    On Windows this is typically Git Bash / WSL. Many Honey Badger features (the
