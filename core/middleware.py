...
INTERNAL_TOOL_TOKEN = os.environ.get("HONEYBADGER_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Honey Badger-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Honey Badger-Internal-Token), or
