...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-Honey Badger-Origin"] = "honeybadger-ui"
            msg["X-Honey Badger-Kind"] = "task"
            msg["X-Honey Badger-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-Honey Badger-Origin": "honeybadger-ui",
                "X-Honey Badger-Kind": "task",
                "X-Honey Badger-Ref": str(task.id),
            },
        }
        if recipient:
