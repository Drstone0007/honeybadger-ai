...
Migrates:
  - Memory vectors: data/memory_vectors/ -> honeybadger_memories collection
  - RAG vectors:    data/rag/            -> honeybadger_rag collection
