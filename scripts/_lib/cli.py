"""scripts/_lib/cli.py — shared scaffolding for the `honeybadger-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("honeybadger-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/honeybadger-foo`
...
VERSION = "0.1.0"  # bumped centrally; every honeybadger-* CLI reports this
